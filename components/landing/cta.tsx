...
export function CTA() {
	return (
		<section className="relative bg-gradient-to-br from-brand-600 via-accent-600 to-brand-700 py-16 sm:py-20 overflow-hidden">
			...
			<div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 lg:flex lg:items-center lg:justify-between relative z-10">
				...
				<div className="mt-8 flex lg:mt-0 lg:flex-shrink-0 lg:ml-8 space-x-4">
					<div className="inline-flex rounded-md shadow">
						<Link
							href="/register"
							className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-brand-600 bg-white hover:bg-gray-50 transition-colors duration-200"
						>
					...
					<div className="inline-flex rounded-md shadow">
						<a
							href="#how-it-works"
							className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-brand-800 bg-opacity-60 hover:bg-opacity-70 transition-colors duration-200"
						>
